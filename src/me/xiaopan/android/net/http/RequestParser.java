...
import me.xiaopan.android.net.http.annotation.CacheIgnore;
import me.xiaopan.android.net.http.annotation.False;
import me.xiaopan.android.net.http.annotation.Header;
import me.xiaopan.android.net.http.annotation.Host;
import me.xiaopan.android.net.http.annotation.Method;
import me.xiaopan.android.net.http.annotation.Name;
import me.xiaopan.android.net.http.annotation.Param;
import me.xiaopan.android.net.http.annotation.Path;
import me.xiaopan.android.net.http.annotation.ResponseBody;
import me.xiaopan.android.net.http.annotation.True;
import me.xiaopan.android.net.http.annotation.URL;
import me.xiaopan.android.net.http.annotation.Value;
import me.xiaopan.android.net.http.enums.MethodType;
...
public class RequestParser {
    ...
    public static CacheConfig parseResponseCacheAnnotation(Context context, Class<? extends Request> requestClass){
        me.xiaopan.android.net.http.annotation.CacheConfig annotation = requestClass.getAnnotation(me.xiaopan.android.net.http.annotation.CacheConfig.class);
        if(annotation == null){
            return null;
        }
