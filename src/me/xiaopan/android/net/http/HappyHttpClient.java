...
public class HappyHttpClient {
	private static HappyHttpClient instance;
	private Configuration configuration;	//配置
    private Map<Object, List<RequestHandle>> requestMap;	//请求Map
	
    public HappyHttpClient(Context context){
	 ...
	 * @return 实例
	 */
	public static HappyHttpClient getInstance(Context context){
		if(instance == null){
			instance = new HappyHttpClient(context);
		}
		return instance;
	}
