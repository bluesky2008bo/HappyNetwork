...
//		}));
		...
		EasyHttpClient.getInstance().get("http://www.weather.com.cn/data/cityinfo/101010100.html", new DefaultJsonHttpResponseHandler(getBaseContext(), WeatherResponse.class, new DefaultJsonHttpResponseHandleListener<WeatherResponse>() {
			@Override
			public void onStart() {
				findViewById(R.id.loading).setVisibility(View.VISIBLE);
			}
