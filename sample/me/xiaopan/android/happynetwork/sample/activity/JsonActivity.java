...
import me.xiaopan.android.happynetwork.http.JsonHttpResponseHandler;
import me.xiaopan.android.happynetwork.sample.MyActivity;
import me.xiaopan.android.happynetwork.sample.beans.Weather;
import me.xiaopan.android.happynetwork.sample.net.Failure;
import me.xiaopan.android.happynetwork.sample.net.request.BeijingWeatherRequest;
...
public class JsonActivity extends MyActivity {
	...
	private void load(){
		HappyHttpClient.getInstance(getBaseContext()).execute(new BeijingWeatherRequest(), new JsonHttpResponseHandler<Weather>(getBaseContext(), Weather.class, true) {
			@Override
