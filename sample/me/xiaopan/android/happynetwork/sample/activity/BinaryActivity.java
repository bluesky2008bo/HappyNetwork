...
import me.xiaopan.android.happynetwork.http.BinaryHttpResponseHandler;
...
public class BinaryActivity extends MyActivity {
	...
	private void load(){
		HappyHttpClient.getInstance(getBaseContext()).get("http://img.pconline.com.cn/images/upload/upc/tx/wallpaper/1311/11/c0/28529113_1384156076013_800x600.jpg", new BinaryHttpResponseHandler(true) {
			@Override
